...
def train_epoch(lstm_model: nn.Module, device: torch.device, dataloader_in, dataloader_out, loss_fn, optimizer):

    # set the train mode for lstm_model
    lstm_model.train()
    ...
    for image_batch_in, image_batch_out in zip(dataloader_in, dataloader_out):
        ...
        # use the lstm model to predict data
